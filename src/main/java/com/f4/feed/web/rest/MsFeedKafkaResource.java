...
import com.f4.feed.kafka.broker.KafkaConsumer;
import com.f4.feed.kafka.handler.EventEnvelope;
...
public class MsFeedKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(MsFeedKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public MsFeedKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
