...
import com.f4.feed.client.auth.HttpBasicAuth;
import com.f4.feed.client.auth.HttpBearerAuth;
import com.f4.feed.client.auth.ApiKeyAuth;
import com.f4.feed.client.ApiResponseDecoder;
